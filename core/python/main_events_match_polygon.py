...
@FileName:  main_events_match_polygon.py
...
def run_app() -> None:
    ...
    for month in range(start_month, end_month+1):
        ...
        coal_ship_statics_df = load_coal_ship_statics(con=var.engine)
        # coal_events_df = events_df.loc[events_df['mmsi'].isin(coal_ship_statics_df['mmsi'])]
        ...
        # print(coal_events_df.loc[coal_events_df['coal_dock_id'].notnull()])
